 ...
 * @author fiscrob
 */
public class MSSqlDate extends SqlDate
{
public MSSqlDate(Calendar cal, boolean nullable) {
	super(cal,nullable);
}
/** @param stz TimeZone of dates stored in database. */
public MSSqlDate(String stz, boolean nullable) {
	super(stz, nullable);
}
public MSSqlDate(TimeZone tz, boolean nullable) {
	super(tz, nullable);
}
