...
//import citibob.swing.sybase.SqlTimestampSwinger;
import citibob.sql.sybase.*;
 ...
 * @author citibob
 */
public class SybaseSwingerMap extends JavaSwingerMap
{
 ...
 */
public SybaseSwingerMap(final TimeZone tz) {
	super(tz);
	...
	this.addMaker(citibob.sql.ansi.SqlTimestamp.class, new BaseSwingerMap.Maker() {
	public Swinger newSwinger(JType jType) {
