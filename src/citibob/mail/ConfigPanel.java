...
public class ConfigPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(useNamePasswd, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(serverName, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        add(bOK, gridBagConstraints);

        bReset.setText("Revert");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(yourName, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(emailAddress, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(replyToAddress, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(organization, gridBagConstraints);
...
public static boolean isConfigured()
{
	...
	p = p.node("org/peeragent/spooler");
	String host = p.get("mail.smtp.host", "");
	return !("".equals(host));
}
// -----------------------------------------------------    
...
{
	readConfig(Preferences.userNodeForPackage(this.getClass()));
}
// -----------------------------------------------------    
...
{
	writeConfig(Preferences.userNodeForPackage(this.getClass()));
}
// -----------------------------------------------------    
